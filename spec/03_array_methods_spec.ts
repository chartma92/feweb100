    ...
    describe('examples', () => {
        ...
        describe('methods that produce a new array', () => {
            ...
            it('creating a new array from each element', () => {
                ...
                const stringEvens = numbers.filter(isEven)
                    .map(n => n * 2)
                    .map(n => n.toString());
    ...
    describe('practical use', () => {
        ...
        it('your practice 1', () => {
            ...
            const answer: string[] = vehicles
                .filter(vehicles => vehicles.mileage > 100_000)
                .map(veh => veh.info)
                .map(veh => `${veh.make} ${veh.model}`);// The make and model of all vehicles with > 100_000 miles on them.
